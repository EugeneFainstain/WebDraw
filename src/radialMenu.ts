...
import {
    ...
    areShapeButtonsVisible,
    clearShapeSession,
    type ShapeType
} from './radialMenu/basicShapes';

// Re-export ShapeType for external consumers
export type { ShapeType } from './radialMenu/basicShapes';
...
export function initRadialMenu(cb: RadialMenuCallbacks): void {
    ...
    if (radialMenuEl) {
        ...
        createColorButtons();
        createSizeButtons();
        createShapeButtons(radialMenuEl, callbacks.getCurrentColor, callbacks.getCurrentSize);
